...
export function PokemonCard({ pokemon }: { pokemon: Pokemon }) {
  ...
  return (
    <li
      ...
      hover:-translate-y-2 hover:rotate-[5deg] hover:shadow-2xl hover:shadow-black/40 dark:hover:shadow-white/20
       bg-white dark:bg-gray-800 border-2 border-indigo-100 cursor-pointer max-w-[250px] w-full animate-fade-slide-up`}
    >
