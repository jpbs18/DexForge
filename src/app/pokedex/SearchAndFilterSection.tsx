  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-8">
      ...
      <select
        ...
        className="w-full md:w-1/4 rounded-lg border border-slate-300 bg-white px-4 py-2 text-gray-800 focus:outline-none focus:ring-4 focus:ring-green-500 shadow-sm"
      >
